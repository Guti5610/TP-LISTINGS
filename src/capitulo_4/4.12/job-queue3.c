...
/* Dummy function to simulate processing a job */
...
void enqueue_job(int job_id) {
    struct job* new_job;

    /* Allocate a new job object. */
    new_job = (struct job*) malloc(sizeof(struct job));
    new_job->job_id = job_id;  // set job-specific data
...
int main() {
    ...
    /* Normally you would signal threads to exit properly.
